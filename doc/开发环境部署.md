...
🌐 [AutoDL 镜像](https://www.codewithgpu.com/i/chatchat-space/ecap/ecap) ，已经更新到`V13`版本,对应`0.2.9`
...
```shell
# 拉取仓库
$ git clone --recursive https://github.com/chatchat-space/ecap.git
...
## 一键启动
启动前，确保已经按照[参数配置](https://github.com/chatchat-space/ecap/wiki/%E5%8F%82%E6%95%B0%E9%85%8D%E7%BD%AE)正确配置各config模块。
