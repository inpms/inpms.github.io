...
![](https://github.com/chatchat-space/ecap/blob/master/img/logo-long-chatchat-trans-v2.png)
...
📃 **ecap** (原 Langchain-ChatGLM):  基于 Langchain 与 ChatGLM 等大语言模型的本地知识库问答应用实现。
...
![实现原理图](https://github.com/chatchat-space/ecap/blob/master/img/langchain+chatglm.png)

从文档处理角度来看，实现流程如下：

![实现原理图2](https://github.com/chatchat-space/ecap/blob/master/img/langchain+chatglm2.png)
